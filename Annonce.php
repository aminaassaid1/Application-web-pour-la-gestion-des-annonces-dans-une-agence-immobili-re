    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="signin.php" class="nav-link scrollto"><i class="bx bx-user"></i> <span>Sign out</span></a></li>
          <li><a href="#" class="nav-link scrollto active"><i class="bx bx-server"></i> <span>Depose Annonce</span></a>
          </li>
          <li><a href="index.php" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Contact</span></a>
          </li>
          <li><a href="index.php" class="nav-link scrollto "><i class="bx bx-server"></i> <span>Services</span></a>
          </li>
        </ul>
      </nav><!-- .nav-menu -->
    </div>
