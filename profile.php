...
<body>
    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="EditerProfile.php" class="nav-link scrollto "><i class="bx bx-user"></i> <span>Editer Profile</span></a></li>
          <li><a href="Annonce.php" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Depose Annonce</span></a></li>
  ...
  <section class="vh-70" style="background-color: #fff;">
    ...
    <video autoplay muted loop id="myVideo">
      <source src="assets/img/modele-87789 (1).mp4" type="video/mp4">
    </video>
    ...
    ?>
      <div class="row" style="padding:7%;margin-left:25%;margin-top:-8%;">
        <div class="card" id="cards" style="background-color: #DFF3FC;width:90%;margin-bottom:3%;border:1px solid #000;">
          <div id="modal">
