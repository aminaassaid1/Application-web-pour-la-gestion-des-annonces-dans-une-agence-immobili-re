  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          <li><a href="index.php" class="nav-link scrollto "><i class="bx bx-user"></i> <span>Home</span></a></li>
  ...
  <section class="vh-70" style="background-color: #fff;">
    ...
    <div class="row" style="padding:2%;margin-left:27%;">
      ...
      if (isset($_POST['recherche'])) {
        ...
        $type_annonces = $_POST["type_annonces"];
        $villes = $_POST["villes"];
        ...
        elseif ($maxPrix != "" && $minPrix != "" && $categories != "") {
          $query = "SELECT * FROM annonce WHERE prix BETWEEN $minPrix AND $maxPrix AND categorie ='$categories' ";
          $result = mysqli_query($con, $query);
        }
        elseif ($maxPrix != "" && $minPrix != "" && $categories != "" && $type_annonces != "") {
          $query = "SELECT * FROM annonce WHERE prix BETWEEN $minPrix AND $maxPrix AND categorie ='$categories' AND type_annonce='$type_annonces' ";
          $result = mysqli_query($con, $query);
        }
        elseif ($maxPrix != "" && $minPrix != "" && $categories != "" && $type_annonces != "" && $villes != "") {
          $result .= mysqli_query($con, " ");
          $query = "SELECT * FROM annonce WHERE prix BETWEEN $minPrix AND $maxPrix AND categorie ='$categories' AND type_annonce='$type_annonces' AND ville ='$villes'";
          $result = mysqli_query($con, $query);
        }
        elseif ($villes !== "") {
        ...
        elseif ($categories !== "") {
          $query = "SELECT * FROM annonce WHERE categorie ='$categories'";
          $result = mysqli_query($con, $query);
        }
                ...
                <div class="infoModal" style="margin-bottom:-3%;">
                  ...
                  <div style="display: flex;margin-top:3%;">
                    ...
                    ?>
                      ...
                      <img class="card-text" width="37%" height="200vh;" style="margin-top: 5%;" src="<?php echo $rows['image_main']; ?>">
                    <?php
                    }
                    ?>
